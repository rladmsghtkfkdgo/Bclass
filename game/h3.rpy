label mk2:
    ...
    menu:
        ...
        "공방가기":
            ...
            ph "아이스크림!"
            pp "흠...비슷한곳을 알아. 가자."
            scene 임실치즈마을st아이스크림이랑 치즈만드는곳
            show hu_yumm at right
            ...
            menu:
                ...
                "아냐 휴 각자꺼 먹자 그냥..ㅎ":
                    $pl-=5
                    hide hu_yumm
                    show hu_angry at left
                    ph "네놈은 목숨이 여러개인가보구나. 감히 짐의 말에 토를 다는걸 보아하니. 어디 네놈이 아이스크림이 되는게 빠를지 곱게 니놈의 아이스크림을 내놓는게 빠를지 겨뤄보겠느냐."
                    pp "아뇨 가져가세요..."
    scene hu_street
    show hu_icecream3 at right
    ...
    menu:
        "휴는 왜 세상을 멸망시키려는거야?":
            ...
            ph "...[pp]. 인간은 언젠가 죽어. 너 하나로 포기할만큼 내 숙명은 하찮은것이 아니란다."
            pp "...그래"
        "그래그래 얼른 집이나 가자 마왕님.":
            $pl+=10
            hide hu_smile
